...
<br><br>
<i>www.rouxa.com.ve</i> ha sido construida para dar a conocer los productos y/o servicios ofrecidos por <b>Rouxa C.A.</b>, consistentes en la puesta a disposición de un servicio de compra online de prendas de vestir y complementos. Asimismo, también se puede encontrar información sobre las tendencias de la industria de la moda, recomendaciones y noticias.
<br><br>
...
Los títulos utilizados en este acuerdo se incluyen solo por conveniencia y no limita o afecta a estos Términos.
       ...
       SECCIÓN 3 - PROPIEDAD INTELECTUAL E INDUSTRIAL
            ...
            <p id="res">
               Rouxa CA es la titular de todos los derechos de propiedad intelectual de la página www.rouxa.com.ve así como de su código fuente, diseño, estructuras de navegación y los distintos elementos en ellas contenidos en la misma. Corresponden también a Rouxa CA el ejercicio exclusivo de los derechos de explotación de los mismos en cualquier forma y, en especial, los derechos de reproducción, distribución, comunicación pública y transformación.
               <br><br>
...
<br><br>
La autorización al Usuario para el acceso a la web no supone renuncia, transmisión, licencia o cesión total ni parcial sobre derechos de propiedad intelectual o industrial por parte de Rouxa C.A.
            </p>
            <hr>
         </div>
         <div id="topic" class="container">
...
3.- Deposito bancario
<br><br>
4.- Con dinero en cuenta en mercado pago
<br><br>
Si usted presenta dificultades al realizar proceso de pago, por favor proceda a comunicare con nuestro equipo de atención al cliente Rouxavzla@gmail.com
<br><br>
...
<br><br>
En caso de haberse facturado cargos que no hubiesen correspondido, deberá comunicarse con nuestro equipo de Atención al Cliente para resolver dicha cuestión (Rouxavzla@gmail.com)
            </p>
            <hr>
         </div>
                   <div id="topic" class="container">
...
Nos reservamos el derecho, a nuestra sola discreción, de actualizar, modificar o reemplazar cualquier parte de estas Condiciones del servicio mediante la publicación de las actualizaciones y los cambios en nuestro sitio web. Es tu responsabilidad revisar nuestro sitio web periódicamente para verificar los cambios. El uso contínuo de o el acceso a nuestro sitio Web o el Servicio después de la publicación de cualquier cambio en estas Condiciones de servicio implica la aceptación de dichos cambios.
       ...
       SECCIÓN 23 - INFORMACIÓN DE CONTACTO
            ...
            <p id="res">
               Preguntas acerca de los Términos de Servicio deben ser enviadas a Rouxavzla@gmail.com
            </p>
