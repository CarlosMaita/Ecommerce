   ...
   <div style="min-height:100vh; background: #ddd">
     ...
     <div class="container p-3 vista">
      <div id="topic" class="container">
            <p id="res">
                <b>Rouxa C.A.</b> Se reserva el derecho de modificar dichas políticas de devoluciones, en el momento que lo considere necesario. Las modificaciones de dichas políticas serán publicadas y/o divulgadas a través de correo y redes sociales.
            <br><br>
Es deber del usuario mantenerse informado de nuestras políticas de devoluciones a la hora de realizar una compra en nuestro sitio web.
    ...
    <div id="topic" class="container">
            ...
            <p id="res">
Rouxa C.A. No Acepta devoluciones por parte de los usuarios a menos que haya recibido un artículo con defectos de fábrica o que el producto recibido no sea el correcto.
<br><br>
De igual manera, Rouxa C. A. Hará todo el esfuerzo por brindar información precisa, exacta y detallada de todos los artículos y/o servicios  que se muestran en www.rouxa.com.ve. Es su deber revisar detalladamente cada imagen e información suministrada en nuestro sitio web, para evitar así posibles confusiones.
            </p>
            <hr>
         </div>
        <div id="topic" class="container">
...
En el caso de que a usted, se le haya enviado un pedido incorrecto o un producto defectuoso, por favor notificarlo inmediatamente vía e-mail a nuestro equipo de atención al cliente Rouxavzla@gmail.com  con la llave digital de la compra y nombre del artículo incorrecto o defectuoso.
<br><br>
...
Los costes de envío son reembolsables única y exclusivamente para estos casos donde nosotros cometimos el error.
        ...
        REMBOLSO DE DINERO
            ...
            <p id="res">
               Los reembolsos sólo son aplicables en los casos donde la mercancía cuenta con defectos de fábrica y/o el producto enviado a sido incorrecto.
<br><br>
