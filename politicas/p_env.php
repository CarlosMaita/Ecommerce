...
Tenga en cuenta que las empresas de encomienda puede incurrir en retrasos por distintos motivos, No nos hacemos responsables de dichos retrasos.
    ...
    ENVIOS FUERA DEL TERRITORIO NACIONAL
      ...
      INFORMACION ADICIONAL
            ...
            <p id="res">
                Si tiene problemas a la hora de completar los campos solicitados de envíos, puede escribirnos a nuestro correo de atención al cliente ( Rouxavzla@gmail.com ).
<br><br>
Rouxa C.A. no se hace responsable de cualquier extravío o elemento faltante en el caso donde por error u omisión la empresa de  encomiendas y/o paquetes  realiza cambio en los datos de información  del envío, tales como dirección, cédula o nombre del receptor,  teléfono.  Adicionalmente, Rouxa C.A.  no se hace responsable de paquetes perdidos, dañados o retrasados en tránsito.
<br><br>
