...
<body>
  ...
  $("#iniciar").click(function(){
    if(passw == 1){
      document.getElementById("pass").innerHTML = "Password "+" <span class='text-danger'>¡Contraseña Incorrecta!</span>";
    }
    if(usuario == 1){
      document.getElementById("usuario").innerHTML = "Correo "+" <span class='text-danger'>Correo Incorrecto!</span>";
    }
  });
  </script>
