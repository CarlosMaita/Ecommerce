...
?>
   <html>
    ...
    <body onload="deshabilitaRetroceso()">
        <div class="container">
           <h1 id="titulo">Empaquetado - Rouxa</h1>
            ...
            $sql2="SELECT `IDINVENTARIO`, `CANTIDAD` FROM `ITEMS` WHERE `IDPEDIDO`='$id'";
             ...
             $result2 = $conn->query($sql2);
                ...
                <li>
                    <ul id="line-botones">
                        <li>
                          <a href="Empaquetado.php?orden=good&id=<?php echo $id;?>" id="good" onclick="return confirma()">LISTO</a> 
                        </li>
                        <li>
                ...
                <li>
                   ...
                   ?>
                         <p id="titulo" style="color:red">Sin pedidos por empaquetar</p>
                      <?php
              }
                    $conn->close()
